...
<head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?= base_url('assets/css/demo3/style.css') ?>?rnd=<?= rand(11111, 99999) ?>">
...
<body>
            ...
            <div class="page-content">
                <div class="row chat-wrapper">
                    <div class="col-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">تقدم الاطفال</h6>
    ...
    <div id="reportData" style="display: none;">
        <?= json_encode([
            'تقدير الأعمال الخيرية والمسؤولية تجاه الآخرين' => $report[1]->avg,
            'التشجيع على الادخار وتقديره' => $report[2]->avg,
            'التخطيط للشراء وتحديد الآثار المترتبة على قرارات الشراء' => $report[3]->avg,
            'تحديد مصادر الدخل المختلفة' => $report[4]->avg,
            'تحديد الأولويات بناء على الحاجات و الرغبات' => $report[5]->avg
        ]) ?>
    </div>
    ...
    <script>
        ...
        function sendMessage(is_first = false) {
            ...
            if (message != '' || is_first) {
                ...
                html = '<li class="message-item friend chatLoader"><div class="content"><div class="message"><div class="bubble"><p><div class="spinner-grow spinner-grow-sm" role="status"><span class="visually-hidden">Loading...</span></div><div class="spinner-grow spinner-grow-sm" role="status"><span class="visually-hidden">Loading...</span></div><div class="spinner-grow spinner-grow-sm" role="status"><span class="visually-hidden">Loading...</span></div></p></div></div></div></li>';
                $('.messages').append(html);
                $(".chat-body").animate({
                    scrollTop: 999999999
                });
                $.ajax({
                    method: 'post',
                    url: '<?= site_url('chat/home/reportChat') ?>',
                    data: {
                        report: $('#reportData').html(),
                        message: message,
                        messages: messages
                    },
        ...
        var options = {
            ...
            xaxis: {
                categories: [
                    ['تقدير الأعمال الخيرية', 'والمسؤولية تجاه الآخرين'],
                    ['التشجيع على', 'الادخار وتقديره'],
                    ['التخطيط للشراء وتحديد', 'الآثار المترتبة على قرارات الشراء'],
                    ['تحديد مصادر', 'الدخل المختلفة'],
                    ['تحديد الأولويات بناء', 'على الحاجات و الرغبات'],
                ],
                labels: {
                    show: true,
                    style: {
